...
pub fn PaginationPrevious(
    ...
    let classes = format!(
        "gap-1 pl-2.5 inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground h-9 px-4 py-2 {}",
        class
    );
    view! {
...
pub fn PaginationNext(
    ...
    let classes = format!(
        "gap-1 pr-2.5 inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground h-9 px-4 py-2 {}",
        class
    );
    view! {
