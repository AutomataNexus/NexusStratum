...
#[component]
pub fn Carousel(#[prop(optional, default = String::new())] class: String, children: Children) -> impl IntoView {
    let classes = format!("relative {}", class);
    view! { <div class=classes role="region" aria-roledescription="carousel">{children()}</div> }
}

#[component]
pub fn CarouselContent(#[prop(optional, default = String::new())] class: String, children: Children) -> impl IntoView {
    let classes = format!("flex overflow-hidden {}", class);
    view! { <div class=classes>{children()}</div> }
}

#[component]
pub fn CarouselItem(#[prop(optional, default = String::new())] class: String, children: Children) -> impl IntoView {
