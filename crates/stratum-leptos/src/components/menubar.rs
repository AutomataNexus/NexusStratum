...
#[component]
pub fn Menubar(#[prop(optional, default = String::new())] class: String, children: Children) -> impl IntoView {
...
#[component]
pub fn MenubarMenu(#[prop(optional, default = String::new())] class: String, children: Children) -> impl IntoView {
...
#[component]
pub fn MenubarTrigger(#[prop(optional, default = String::new())] class: String, children: Children) -> impl IntoView {
    let open = use_context::<RwSignal<bool>>().expect("MenubarTrigger must be inside MenubarMenu");
    let classes = format!("flex cursor-default select-none items-center rounded-sm px-3 py-1 text-sm font-medium outline-none focus:bg-accent focus:text-accent-foreground data-[state=open]:bg-accent data-[state=open]:text-accent-foreground {}", class);
    view! {
...
#[component]
pub fn MenubarContent(#[prop(optional, default = String::new())] class: String, children: Children) -> impl IntoView {
